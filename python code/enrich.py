...
"""
import pandas as pd
from scrapping import replace_code, country_code, suicides, what
from apiRequests import temperature, precipitations
from seleniumPractice import medals

#Import happy data API, already clean
happy_data = pd.read_csv('../input/Happy2019.csv', engine = 'python')
