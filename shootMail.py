        ...
        <html>
          ...
          <body>
            ...
            <h2> Temperature vs Happiness</h2>
                <img src = 'temperature.png' width = '100' height = '100' alt = 'Temperature vs happiness' />
            <h2> Precipitations vs Happiness</h2>
                <img src = "precipitations" alt = "Temperature vs happiness">
            <h2> Suicide vs Happiness</h2>
                <img src = "suicides" alt = "Temperature vs happiness">
            <h2> Olympic medals vs Happiness</h2>
                <img src = "medals" alt = "Temperature vs happiness">
          </body>
        </html>
        """)
    try:
